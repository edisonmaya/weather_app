...
const Button_slider = ({dark , setDark}) => {
 ...
 const btn_light_mode =<span className="w-12 h-6 flex items-center flex-shrink-0 p-1 bg-gray-300 rounded-full duration-300 ease-in-out peer-checked:bg-[#FFFFFF] after:w-4 after:h-4  after:bg-blue-500 after:rounded-full after:shadow-md after:duration-300 peer-checked:after:translate-x-6 group-hover:after:translate-x-1"></span>
