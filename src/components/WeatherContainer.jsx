...
*/
    return (
        <section className="grid gap-8 text-center ">
            ...
            <article className="grid grid-cols-3  divide-x py-4 justify-center items-center bg-slate-500/50 rounded-2xl min-h-max w-full gap-1 sm:grid-cols-1  sm:divide-x-0 sm:divide-y-2">
